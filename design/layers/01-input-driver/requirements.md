...
- device: adapters/voice-mic.yaml      # driver: audio-voice
  connection: { device_name: "Shure SM58" }
- device: adapters/voice-spec.yaml     # driver: audio-spectrum
  connection: { device_name: "Shure SM58" }  # ← 同 modality, 同 device_name → エラー
```

```yaml
# OK: modality が違う
- device: adapters/els03.yaml          # driver: midi
...
- device: adapters/voice-mic.yaml      # driver: audio-voice
  connection: { device_name: "Shure SM58" }
- device: adapters/spec-electone.yaml  # driver: audio-spectrum
